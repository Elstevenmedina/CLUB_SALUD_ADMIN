...
b[2].toLowerCase()),d[c]=e,"o"===b[1]&&E(a[e]))});a._hungarianMap=d}function P(a,b,c){a._hungarianMap||E(a);var d;l.each(b,function(e,h){d=a._hungarianMap[e];d===q||!c&&b[d]!==q||("o"===d.charAt(0)?(b[d]||(b[d]={}),l.extend(!0,b[d],b[e]),P(a[d],b[d],c)):b[d]=b[e])})}function ma(a){var b=u.defaults.oLanguage,c=b.sDecimal;c&&Wa(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"No hay datos disponibles en esta tabla"===b.sEmptyTable&&X(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&
...
sNext:"Next",sPrevious:"Previous"},sEmptyTable:"No hay datos disponibles en esta tabla",sInfo:"Mostrando _START_ de _END_ en _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 de 0 en 0 entradas",sInfoFiltered:"(Filtrado de _MAX_ entradas totales)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ entradas",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"¡Ups! No hemos encontrado ningún dato"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
